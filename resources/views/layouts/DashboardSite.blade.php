...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: rgb(10, 172, 115)">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('Admin')}}">
                    ...
                    <span>Tableau de Bord Site touristiques</span></a>
            </li>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('Adminhotels')}}">Gallerie</a>
                    ...
                    <form
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn " type="button" style="background-color: rgb(17, 23, 65)" >
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; Ebolowa Cameroun 2024</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
